                ...
                <div class="row">
                    ...
                    <div class="row w-100 flex-grow">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-title">Laporan Booking</p>
                                    <p class="text-muted">Statistik booking terbaru</p>
                                    <div class="row mb-3">
                                        <div class="col-md-7">
                                            <div class="d-flex justify-content-between traffic-status">
                                                <div class="item">
                                                    <p class="mb-">Total Booking</p>
                                                    <h5 class="font-weight-bold mb-0">120</h5>
                                                    <div class="color-border"></div>
                                                </div>
                                                <div class="item">
                                                    <p class="mb-">Booking Dibatalkan</p>
                                                    <h5 class="font-weight-bold mb-0">15</h5>
                                                    <div class="color-border"></div>
                                                </div>
                                                <div class="item">
                                                    <p class="mb-">Pendapatan</p>
                                                    <h5 class="font-weight-bold mb-0">Rp 5,250,000</h5>
                                                    <div class="color-border"></div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="nav nav-pills nav-pills-custom justify-content-md-end" id="pills-tab-custom"
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="pills-home-tab-custom" data-toggle="pill"
                                                        href="#pills-daily" role="tab" aria-controls="pills-home" aria-selected="true">
                                                        Harian
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="pills-weekly-tab-custom" data-toggle="pill" href="#pills-weekly"
                                                        role="tab" aria-controls="pills-profile" aria-selected="false">
                                                        Mingguan
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="pills-monthly-tab-custom" data-toggle="pill" href="#pills-monthly"
