    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('tamu/'.$tamu->id,[]) }}" method="POST" >
                        ...
                        <div class="form-group">
                            ...
                            <input id="catatan" class="form-control" type="text" name="catatan"
                                value="{{ $tamu->catatan ?? old('catatan') }}">
